...
public class MappedBusReaderTest {
    ...
    public void testReadEOF() throws Exception {
        int fileSize = MappedBusConstants.Length.Limit + MappedBusConstants.Length.RecordHeader + RECORD_SIZE;
    ...
    @Test public void testCrashBeforeCommitRollbackBySameReader() throws Exception {
        ...
        mem.putIntVolatile(MappedBusConstants.Structure.Data, 0);
    ...
    public void testCrashBeforeCommitRollbackByDifferentReaderBefore() throws Exception {
        ...
        // set commit flag to false for the first record
        MemoryMappedFile mem = new MemoryMappedFile(FILE_NAME, FILE_SIZE);
        mem.putByteVolatile(MappedBusConstants.Structure.Data, MappedBusConstants.Commit.NotSet);
        ...
        mem.putByteVolatile(MappedBusConstants.Structure.Data + MappedBusConstants.Length.Commit, MappedBusConstants.Rollback.Set);
